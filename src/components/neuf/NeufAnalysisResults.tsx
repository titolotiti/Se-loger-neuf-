  ...
  return (
    <div className={`rounded-lg border p-4 ${panelColor}`}>
      ...
      <div className="flex flex-wrap gap-3 text-xs mb-3">
        ...
        <Stat label="Liens bruts" value={report.totalLinksFound} />
        ...
        {report.promoterLinksSkipped != null && report.promoterLinksSkipped > 0 && (
          <Stat label="Promoteurs filtrés" value={report.promoterLinksSkipped} warn />
        )}
        {report.programLinksRetained != null && (
...
export default function NeufAnalysisResults({ result, onExport, exportLoading }: Props) {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Rapport de scraping — affiché si problème détecté ou 0 résultat */}
      {result.scrapeReport && (result.programs.length === 0 || result.scrapeReport.diagnosisType != null) && (
